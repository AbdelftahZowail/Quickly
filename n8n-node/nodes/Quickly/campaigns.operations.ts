...
export const campaignOperations: INodePropertyOptions[] = [
  {
    name: 'Get Many',
    value: 'getAll',
...
const campaignIdField = (operations: string[]): INodeProperties =>
  resourceLocatorField(
    'Campaign',
    'campaignId',
    'searchCampaigns',
    'e.g. 42',
    { show: { resource: ['campaign'], operation: operations } },
    true,
    'From List or By ID (numeric id or expression)',
  );
...
export const campaignFields: INodeProperties[] = [
  ...
  },
  {
    ...
    description:
      'JSON array of campaign IDs in priority order, e.g. [3,1,2]. Sent as campaign_ids to POST /api/campaigns/reorder.',
  },
  resourceLocatorField(
    'Sequence',
    'sequenceId',
    ...
    true,
    'Sequences for the selected campaign',
    undefined,
    ['campaignId'],
  ),
  resourceLocatorField(
    ...
    false,
    'Optional — leads enrolled in this campaign',
    undefined,
    ['campaignId'],
  ),
  resourceLocatorField(
    ...
    false,
    'Optional — pick __none__ for default sequence content',
    undefined,
