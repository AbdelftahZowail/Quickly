...
import { SCHEDULING_STRATEGY_OPTIONS } from './constants';
import { resourceLocatorField } from './rlField';

export const settingsOperations: INodePropertyOptions[] = [
  {
...
export const settingsFields: INodeProperties[] = [
  {
    ...
    type: 'options',
    options: SCHEDULING_STRATEGY_OPTIONS,
    default: 'priority',
    required: true,
    displayOptions: {
      show: {
  ...
  resourceLocatorField(
    ...
    'searchKnownIps',
    'e.g. 3',
    { show: { resource: ['settings'], operation: ['deleteKnownIP'] } },
    true,
  ),
  resourceLocatorField(
    'AI Feature',
    ...
    true,
    'Built-in features; By ID for future feature ids',
    'reply_classifier',
  ),
  {
