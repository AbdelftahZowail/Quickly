...
exports.emailAccountFields = exports.emailAccountOperations = void 0;
const rlField_1 = require("./rlField");
exports.emailAccountOperations = [
    {
...
exports.emailAccountFields = [
    (0, rlField_1.resourceLocatorField)('Gmail Account', 'gmailAccountId', 'searchGmailAccounts', 'e.g. 1', {
        show: {
            resource: ['emailAccount'],
            operation: ['gmailDisconnect'],
        },
    }, true),
    (0, rlField_1.resourceLocatorField)('Office 365 Account', 'office365AccountId', 'searchOffice365Accounts', 'e.g. 1', {
        show: {
            resource: ['emailAccount'],
