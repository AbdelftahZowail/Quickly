...
exports.leadFields = [
    ...
    },
    {
        ...
        type: 'options',
        options: [{ name: '— All —', value: '__all__' }, ...constants_1.LEAD_LIST_STATUS_OPTIONS],
        default: '__all__',
        displayOptions: {
            show: {
                resource: ['lead'],
    ...
    (0, rlField_1.resourceLocatorField)('Lead', 'leadId', 'searchLeads', 'e.g. 99', {
        show: {
            resource: ['lead'],
        ...
        options: [
            {
                ...
                name: 'item',
                values: [
                    (0, rlField_1.resourceLocatorField)('Lead', 'lead_id', 'searchLeads', 'e.g. 99', {}, true),
                    {
    ...
    (0, rlField_1.resourceLocatorField)('Lead', 'markRepliedLeadId', 'searchLeads', 'e.g. 99', { show: { resource: ['lead'], operation: ['markReplied'] } }, true),
    (0, rlField_1.resourceLocatorField)('Campaign', 'markRepliedCampaignId', 'searchCampaigns', 'e.g. 42', { show: { resource: ['lead'], operation: ['markReplied'] } }, true),
    {
        displayName: 'New Email',
        name: 'recoverEmail',
        type: 'string',
