...
exports.sequenceVariantFields = exports.sequenceVariantOperations = void 0;
const rlField_1 = require("./rlField");
exports.sequenceVariantOperations = [
    {
        name: 'Get Many',
        value: 'getAll',
...
exports.sequenceVariantFields = [
    (0, rlField_1.resourceLocatorField)('Campaign', 'campaignId', 'searchCampaigns', 'e.g. 42', { show: { resource: ['sequenceVariant'] } }, true),
    (0, rlField_1.resourceLocatorField)('Sequence', 'sequenceId', 'searchSequencesForCampaign', 'e.g. 5', { show: { resource: ['sequenceVariant'] } }, true),
    (0, rlField_1.resourceLocatorField)('Variant', 'variantId', 'searchVariantsForSequence', 'e.g. 7', { show: { resource: ['sequenceVariant'], operation: ['update', 'delete'] } }, true, undefined, undefined, ['campaignId', 'sequenceId']),
    {
        displayName: 'Body',
        name: 'variantBody',
        type: 'string',
