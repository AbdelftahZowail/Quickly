...
exports.sequenceFields = [
    (0, rlField_1.resourceLocatorField)('Campaign', 'campaignId', 'searchCampaigns', 'e.g. 42', { show: { resource: ['sequence'] } }, true),
    (0, rlField_1.resourceLocatorField)('Sequence', 'sequenceId', 'searchSequencesForCampaign', 'e.g. 5', { show: { resource: ['sequence'], operation: ['update', 'delete'] } }, true, undefined, undefined, ['campaignId']),
    {
