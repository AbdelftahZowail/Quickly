...
exports.campaignLeadFields = exports.campaignLeadOperations = void 0;
const constants_1 = require("./constants");
const rlField_1 = require("./rlField");
exports.campaignLeadOperations = [
    {
        name: 'Add Leads',
        value: 'add',
...
exports.campaignLeadFields = [
    (0, rlField_1.resourceLocatorField)('Campaign', 'campaignId', 'searchCampaigns', 'e.g. 42', { show: { resource: ['campaignLead'] } }, true),
    {
    ...
    (0, rlField_1.resourceLocatorField)('Lead', 'campaignLeadId', 'searchLeadsForCampaign', 'e.g. 99', {
        show: {
            resource: ['campaignLead'],
            operation: ['remove', 'updateEnrollment'],
        },
    }, true, 'Leads enrolled in the selected campaign', undefined, ['campaignId']),
    {
        ...
        options: [
            {
                ...
                name: 'status',
                type: 'options',
                options: constants_1.ENROLLMENT_STATUS_OPTIONS,
                default: '',
            },
            {
                ...
                name: 'interest',
                type: 'options',
                options: constants_1.INTEREST_ENROLLMENT_OPTIONS,
                default: '',
    ...
    },
    {
        ...
        type: 'options',
        options: [{ name: '— All —', value: '__all__' }, ...constants_1.ENROLLMENT_STATUS_OPTIONS],
        default: '__all__',
        displayOptions: {
            show: {
                resource: ['campaignLead'],
    ...
    },
    {
        ...
        name: 'exportInterest',
        type: 'options',
        options: [{ name: '— All —', value: '__all__' }, ...constants_1.INTEREST_FILTER_OPTIONS],
        default: '__all__',
        displayOptions: {
            show: {
                resource: ['campaignLead'],
